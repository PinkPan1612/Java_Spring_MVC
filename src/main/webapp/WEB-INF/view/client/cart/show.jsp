                        ...
                        <c:if test="${empty listCartDetail}">
                            <div class="d-flex justify-content-center align-items-center bg-light ">
                                <div class="text-center p-5 border rounded shadow-sm bg-white">
                                    <h2 class="text-danger">Giỏ hàng của bạn đang trống</h2>
                                    <p class="text-muted">Hãy thêm một số sản phẩm vào giỏ hàng của bạn để bắt đầu
                                        mua
                                        sắm!</p>
                                    ...
                                    <tbody>
                                        <c:forEach var="cartDetail" items="${listCartDetail}">
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="mb-0 mt-4"><a target="_blank"
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="d-flex justify-content-between mb-4">
                                                ...
                                                <p class="mb-0" data-cart-total-price="${totalCart}">
                                                    <fmt:formatNumber type="number" value="${totalCart}" />
                                                </p>
                                            </div>
