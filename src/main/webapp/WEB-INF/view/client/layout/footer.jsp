                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                ...
                                <p class="text-secondary mb-0">@rawuy.n</p>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-3    ">
                            <div class="d-flex justify-content-end pt-3">
                                ...
                                <a class="btn btn-outline-secondary me-2 btn-md-square rounded-circle"
                                    href="https://www.facebook.com/nkh.huy.1"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-outline-secondary me-2 btn-md-square rounded-circle" href=""><i
                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p class="mb-2">Mọi mặt hàng đều được kiểm định kĩ càng trước khi đến tay người tiêu dùng
                            </p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            <h4 class="text-light mb-2">Thông tin cửa hàng</h4>
                            <a class="btn-link" href="">Về chúng tôi</a>
                            <a class="btn-link" href="">Kết nối</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            <h4 class="text-light mb-2">Tài khoản</h4>
                            <a class="btn-link" href="">My Account</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            <h4 class="text-light mb-2">Kết nối</h4>
                            <p>Address: HCM City</p>
                            <p>Email: huybguyen881@gmail.com</p>
                            <p>Phone: 0123455678</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Rawuy</a>,
